...
# Application
An application built from https://github.com/redhat-appstudio-mjf/chatbot2-apr25-3 will be stored in [quay.io/maysunfaisal/chatbot2-apr25-3](https://quay.io/maysunfaisal/chatbot2-apr25-3) and deployed through GitOps. This application is accessible on port **8501**.